  ...
  <div class="p-about__inner">
    ...
    <div class="p-about__nav">
      <div class="p-about__btns">
        <a href="#p-company" class="p-about__btn">教室の<br class="is-sp">特徴</a>
      </div>
      <div class="p-about__btns">
        <a href="#p-class" class="p-about__btn">クラス<br class="is-sp">紹介</a>
      </div>
      <div class="p-about__btns">
        <a href="#p-performance" class="p-about__btn">公演<br class="is-sp">一覧</a>
      </div>
    </div>
  </div>
</section>
<section class="p-company l-company" id="p-company">
...
<section class="p-class l-class">
  <div class="p-class__inner" id="p-class">
...
<section class="p-performance l-performance">
  <div class="p-performance__inner">
    <h2 class="p-performance__title" id="p-performance">
      公演
    </h2>
